...
- Replace all occurrences of "MazeGenerator" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `MazeGenerator` means the name of the project, while `greeter` is used in file names.
